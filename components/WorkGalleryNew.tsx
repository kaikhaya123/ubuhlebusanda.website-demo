        ...
        <div className="grid lg:grid-cols-2 gap-8 bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="relative bg-black min-h-[400px] lg:min-h-[600px] flex items-center justify-center">
            ...
            <div className="absolute bottom-6 left-6 flex items-center gap-3 z-10">
              <button
                ...
                className="w-12 h-12 rounded-full bg-white/90 hover:bg-white flex items-center justify-center shadow-lg transition-all hover:scale-105"
            ...
            {/* Project Counter */}
            <div className="absolute top-6 right-6 bg-black/60 text-white px-4 py-2 rounded-full text-sm font-medium">
          ...
          <div className="p-8 lg:p-10 flex flex-col">
            ...
            <div className="mb-8 p-6 bg-amber-50 rounded-xl border-2 border-amber-200">
              ...
              <p className="text-amber-700 mb-3 flex items-center gap-2">
